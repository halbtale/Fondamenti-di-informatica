...
// SimpleAirRoute AirRoute1 = new SimpleAirRoute(AIRPORT2, AIRPORT1, LENGTH1,
// HEIGHT1);
// SimpleAirRoute Airroute2 = new SimpleAirRoute(AIRPORT1, AIRPORT3, LENGTH3,
// HEIGHT3);
// SimpleAirRoute Airroute3 = new SimpleAirRoute(AIRPORT3, AIRPORT2, LENGTH2,
// HEIGHT2);

// // generazione dei vettori aerei
// SimpleAircraft b737 = new SimpleAircraft(MODEL1, AIRPORT1, MAX_LENGTH1,
// MAX_HEIGHT1, MAX_MILEAGE1);
// System.out.println(b737);

// SimpleAircraft a340 = new SimpleAircraft(MODEL2, AIRPORT2, MAX_LENGTH2,
// MAX_HEIGHT2, MAX_MILEAGE2);
